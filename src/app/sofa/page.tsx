...
<section className="text-gray-600 body-font">
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-col text-center w-full mb-20">
      ...
      Description&nbsp;&nbsp;&nbsp; <span className='text-[#9F9F9F]'>Additional Information</span>&nbsp;&nbsp;&nbsp; <span className='text-[#9F9F9F]'>Reviews [5]</span>
      </h1>
      <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
      Embodying the raw, wayward spirit of rock ‘n’ roll, the Kilburn portable active stereo speaker takes the unmistakable look and sound 
      of Marshall, unplugs the chords, and takes the show on the road.. <br />
      <br />
      Weighing in under 7 pounds, the Kilburn is a lightweight piece of vintage styled engineering. Setting the bar as one of the loudest speakers in its class, the Kilburn is a compact, stout-hearted hero with a well-balanced audio which boasts a clear midrange and extended highs for a sound that is both articulate and pronounced. The analogue knobs allow you to fine tune the controls to your personal
    ...
    <div className="flex flex-wrap -m-5 text-center gap-5 justify-center items-center">
      <div className="p-4 md:w-1/3 sm:w-1/1 w-[657px] h-[348px] bg-[#FFF9E5] hover:border-2 hover:border-gray-300">
        <div className="px-4 py-6 rounded-lg">
         <Image src={"/Mask group (14).png"} height={348} width={605} alt='img'>
      ...
      <div className="p-4 md:w-1/3 sm:w-1/1 w-[657px] h-[348px] bg-[#FFF9E5] hover:border-2 hover:border-gray-300">
       ...
       <Image height={348} width={605} src={"/cottoman_1 1.png"} alt='imag'>
